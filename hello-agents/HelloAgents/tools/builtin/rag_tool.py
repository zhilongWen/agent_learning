...
class RAGTool(Tool):
    ...
    def _add_text(self, text: str, document_id: str = None, metadata: Optional[Dict[str, Any]] = None,
                  namespace: Optional[str] = None, chunk_size: int = 800, chunk_overlap: int = 100, **kwargs) -> str:
        """添加文本到知识库"""
        try:
